            ...
            <main className='section-standard'>
                <div>
                    <section className='section-content text-start'>
                        ...
                        <p>La obesidad y el sobrepeso se definen como una acumulación anormal o excesiva de grasa que puede ser perjudicial para la salud. Un índice simple de peso para la talla que se utiliza comúnmente para clasificar el sobrepeso y la obesidad en adultos es el índice de masa corporal (IMC). Se calcula dividiendo el peso de una persona en kilogramos por el cuadrado de la altura en metros. <br/> Un IMC igual o superior a 30 se considera obesidad y un IMC igual o superior a 25 se considera sobrepeso. El IMC proporciona la medida de sobrepeso y obesidad a nivel poblacional más útil, ya que es el mismo para ambos sexos y adultos de todas las edades. Sin embargo, debe considerarse una guía aproximada porque puede no corresponder al mismo grado de gordura en diferentes individuos.<br/> La obesidad es uno de los principales factores de riesgo de muchas enfermedades crónicas, incluidas la diabetes, las enfermedades cardiovasculares, la hipertensión y los accidentes cerebrovasculares, así como varios tipos de cáncer. Además, los niños con sobrepeso tienen mayor riesgo de vivir con sobrepeso u obesidad en la edad adulta. <br/> En el caso de los niños, es necesario tener en cuenta la edad al definir el sobrepeso y la obesidad. <br /> Para niños menores de 5 años: </p>
                        <ul>
